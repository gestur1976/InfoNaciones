 ...
 */
final class Version20231209171720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE currency (id INT AUTO_INCREMENT NOT NULL, currency_code VARCHAR(4) NOT NULL, currency_name VARCHAR(255) NOT NULL, symbol VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
